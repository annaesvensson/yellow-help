---
Title: EUROPEAN UNION PUBLIC LICENCE v. 1.2
---
...
## Hur man tillämpar EUPL på denna programvara

I början av varje källkodsfil finns en länk till en webbplats där licensen finns. Till exempel:

    Datenstrom Yellow, https://datenstrom.se/yellow/

Om du ändrar källkodsfilerna måste du behålla de ursprungliga länkarna och licenserna. Till exempel:

    Coffeepress Black, https://git-hosting-platform/coffeepress/black/
    Based on Datenstrom Yellow, https://datenstrom.se/yellow/

Källkoden till denna programvara är licensierad enligt EUPL version 1.2 — endast enligt denna version — och utan den ovan nämnda kompatibilitetsklausulen, om inte annat anges. Källkoden till denna programvara har gjorts tillgänglig som öppen källkod och får därför inte användas a) i proprietär källkod och b) i proprietära språkmodeller, om inte annat anges.
