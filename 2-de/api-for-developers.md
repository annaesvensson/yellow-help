...
Die Klasse `YellowToolbox` gibt Zugang zu einer Werkzeugkiste mit Hilfsmethoden. Die folgenden Methoden sind verfügbar:
...
YellowCore::sendPage file:content/2-de/2-wiki/page.md
