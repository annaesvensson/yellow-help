...
? Can't download file
?
? Die Datei kann nicht heruntergeladen werden. Diese Fehlermeldung bedeutet in der Regel, dass keine Internetverbindung besteht oder dass ausgehende HTTP-Anfragen an bestimmte Webseiten blockiert werden. Manchmal reicht es schon aus es einfach später noch einmal zu versuchen. Wende dich an den Webmaster, falls diese Fehlermeldung ständig angezeigt wird.
