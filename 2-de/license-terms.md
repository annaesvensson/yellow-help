---
Title: OPEN-SOURCE-LIZENZ FÜR DIE EUROPÄISCHE UNION v. 1.2
---
...
## Wie man die EUPL auf diese Software anwendet

Am Anfang jeder Quellcodedatei befindet sich ein Link zu einer Webseite, auf der die Lizenz zu finden ist. Zum Beispiel:

    Datenstrom Yellow, https://datenstrom.se/yellow/

Wenn Sie Quellcodedateien ändern, müssen Sie die ursprünglichen Links und Lizenzen beibehalten. Zum Beispiel:

    Coffeepress Black, https://git-hosting-platform/coffeepress/black/
    Based on Datenstrom Yellow, https://datenstrom.se/yellow/

Der Quellcode dieser Software ist lizensiert unter der EUPL Version 1.2 — nur unter dieser Version — und ohne die oben erwähnte Kompatibilitäts-Klausel, sofern nicht anders angegeben. Der Quellcode dieser Software wurde als Open-Source zur Verfügung gestellt und darf daher nicht a) in proprietärem Quellcode und b) in proprietären Sprachmodellen verwendet werden, sofern nicht anders angegeben.
