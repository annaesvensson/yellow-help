...
Du findest grundlegende Dokumentation für Webseiten in der Hilfe und ausführlichere Dokumentation in den [Erweiterungen](https://datenstrom.se/de/yellow/extensions/). Stell dir vor was der Benutzer machen möchte und was dessen Leben einfacher machen würde. Überprüfe die Dokumentation aus der Perspektive des Benutzers. Grundsätzlich sollte die Dokumentation aus mehreren Abschnitten bestehen, Beispiele enthalten welche Benutzer kopieren/einfügen können, Einstellungen erläutern welche Benutzer anpassen können und in einer leicht verständlichen Sprache geschrieben sein. Für erfahrene Autoren gibt es einen [Styleguide](https://github.com/annaesvensson/yellow-help/blob/main/yellow-style-guide.md). Hast du die Dokumentation verbessert? Mache ein Fork vom entsprechenden Repository und sende einen Pull-Request an den Entwickler.
