...
People have a right to the protection of personal data. That's why Datenstrom Yellow has been designed in such a way that the collection of personal data is avoided from the very beginning and only as little information as necessary is stored. The source code of this software has been made available as open source. Here's an overview:
...
* Personal data - none per default, but any information you enter on a website may be stored.
...
* Emails and passwords - optional, all user settings are stored in a configuration file.
* Source code - available on Codeberg and GitHub, the license file has further details.
